      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 32 }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            ...
            onMouseOver={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.background = "rgba(255,255,255,0.15)"}
            onMouseOut={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.background = "rgba(255,255,255,0.08)"}>
            ...
            onMouseOver={(e: React.MouseEvent<HTMLElement>) => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 12px 20px rgba(233,196,106,0.3)"; }}
            onMouseOut={(e: React.MouseEvent<HTMLElement>) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 16px rgba(233,196,106,0.25)"; }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <section>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              ...
              <Link href="/lost-pets" style={{ fontSize: 14, color: "#1B3A6B", fontWeight: 700, display: "flex", alignItems: "center", gap: 4, padding: "6px 12px", borderRadius: "100px", background: "#1B3A6B10", transition: "background 0.2s" }}
                onMouseOver={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.background = "#1B3A6B20"}
                onMouseOut={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.background = "#1B3A6B10"}>
          ...
          <section>
            ...
            <div style={{ display: "flex", gap: 16, overflowX: "auto", paddingBottom: 8, margin: "0 -4px", padding: "0 4px" }}>
              ...
              onMouseOver={(e: React.MouseEvent<HTMLElement>) => { e.currentTarget.style.background = "rgba(0,0,0,0.03)"; e.currentTarget.style.borderColor = "rgba(0,0,0,0.25)"; }}
              onMouseOut={(e: React.MouseEvent<HTMLElement>) => { e.currentTarget.style.background = "rgba(0,0,0,0.01)"; e.currentTarget.style.borderColor = "rgba(0,0,0,0.15)"; }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <section>
            ...
            <div style={{
              ...
              {communityActivity.map((event, i) => (
                ...
                onMouseOver={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.background = "#F8FAFC"}
          ...
          <section>
            ...
            <div style={{
              ...
              onMouseOver={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.transform = "translateY(-2px)"}
              onMouseOut={(e: React.MouseEvent<HTMLElement>) => e.currentTarget.style.transform = "none"}>
