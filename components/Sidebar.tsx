...
const sidebarItems: SidebarItem[] = [
  ...
  { href: "/lost-pets", label: "Lost Pets", icon: IconAlertTriangle, roles: ["Owner", "Staff"] },
  { href: "/lost-pets/admin", label: "Lost Pets", icon: IconAlertTriangle, roles: ["Admin"] },
  { href: "/staff/pets", label: "Pet Queue", icon: IconClipboard, roles: ["Staff"] },
  { href: "/admin/pets", label: "Pet Queue", icon: IconClipboard, roles: ["Admin"] },
